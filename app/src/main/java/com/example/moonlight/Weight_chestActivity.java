...
public class Weight_chestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_weight_chest);

        recyclerView = findViewById(R.id.recyclerView);
        s1 = getResources().getStringArray(R.array.chest);
        s2 = getResources().getStringArray(R.array.chest_des);
        youtube = getResources().getStringArray(R.array.chest_youtube);
        AdapterChest chestAdapter = new AdapterChest(this, s1, s2, youtube, images);
