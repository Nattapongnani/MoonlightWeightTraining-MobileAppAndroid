...
public class Weight_backActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_weight_back);

        recyclerView = findViewById(R.id.recyclerView);
        s1 = getResources().getStringArray(R.array.back);
        s2 = getResources().getStringArray(R.array.back_des);
        youtube = getResources().getStringArray(R.array.back_youtube);
        AdapterBack adapterBack = new AdapterBack(this, s1, s2, youtube, images);
        recyclerView.setAdapter(adapterBack);
