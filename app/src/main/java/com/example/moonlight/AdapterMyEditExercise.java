...
public class AdapterMyEditExercise extends ArrayAdapter {

    double trainingVolume;
    public static ArrayList<MyAdapter> arraySelected;
    Context context;

    public AdapterMyEditExercise(Context _context, ArrayList<MyAdapter> _selected) {
    ...
    public void calTrainingVolume(){
        ...
        EditProgram.updateTrainingVolume(trainingVolume);
    }
