...
public class Weight_abActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_weight_ab);
        ...
        AdapterAb adapterAb = new AdapterAb(this, s1, s2, youtube, images);
        recyclerView.setAdapter(adapterAb);
